...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $aton_qodef_Framework, $aton_qodef_options;
        ...
        if(qode_core_theme_installed()) {
            $menuPosition = $aton_qodef_Framework->getSkin()->getMenuItemPosition('portfolio');
            $menuIcon = $aton_qodef_Framework->getSkin()->getMenuIcon('portfolio');

            if(isset($aton_qodef_options['portfolio_single_slug'])) {
                if($aton_qodef_options['portfolio_single_slug'] != ""){
                    $slug = $aton_qodef_options['portfolio_single_slug'];
                }
            }
        }
