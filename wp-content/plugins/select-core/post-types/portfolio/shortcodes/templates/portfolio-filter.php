	...
	<div class = "qodef-portfolio-filter-holder-inner">
		...
		<ul>
			<?php if($type == 'masonry' || $type == 'pinterest'){ ?>
				<li class="filter" data-filter="*"><span><?php esc_html_e('All', 'select-core')?></span></li>
			<?php } else{ ?>
				<li data-class="filter_<?php print $rand_number ?>" class="filter_<?php print $rand_number ?>" data-filter="all"><span><?php esc_html_e('All', 'select-core')?></span></li>
			<?php } ?>
