<?php
if ( ! function_exists( 'aton_qodef_init_google_fonts_array' ) ) {
    function aton_qodef_init_google_fonts_array() {
        ...
        $aton_qodef_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'aton_qodef_init_google_fonts_array');
}