...
include_once 'qodef-twitter-helper.php';

/**
 * Class QodefTwitterApi
 */
class QodefTwitterApi {
    /**
    ...
    const REQUEST_TOKEN_FIELD = 'qodef_twitter_request_token';
    const REQUEST_TOKEN_SECRET_FIELD = 'qodef_twitter_request_token_secret';
    const ACCESS_TOKEN_FIELD = 'qodef_twitter_access_token';
    const ACCESS_TOKEN_SECRET_FIELD = 'qodef_twitter_access_token_secret';
    const AUTHORIZE_TOKEN_FIELD = 'qodef_twitter_authorize_token';
    const AUTHORIZE_VERIFIER_FIELD = 'qodef_twitter_authorize_verifier';
    const USER_ID_FIELD = 'qodef_twitter_user_id';
    const USER_SCREEN_NAME_FIELD = 'qodef_twitter_screen_name';
    ...
    public function __construct() {
        ...
        $this->helper = new QodefTwitterHelper();
    }
    /**
     ...
     *
     * @see QodefTwitterApi::generateSignatureBase()
     */
