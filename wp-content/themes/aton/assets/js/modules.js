    ...
    */
    ...
    function qodefMobileHeaderBehavior() {
        if(qodef.body.hasClass('qodef-sticky-up-mobile-header')) {
            ...
            var mobileMenuOpener = mobileHeader.find('.qodef-mobile-menu-opener');
...
(function($) {
    ...
    shortcodes.qodefInitPortfolioParallaxRows = qodefInitPortfolioParallaxRows;
    ...
    shortcodes.qodefInitFixedPortfolio = qodefInitFixedPortfolio;
    ...
    shortcodes.qodefInitPortfolioAppear =  qodefInitPortfolioAppear;
    ...
    shortcodes.qodefInitSvgSeparator = qodefInitSvgSeparator;
    ...
    */
    function qodefOnWindowLoad() {
        qodefInitFixedPortfolio();
        qodefInitPortfolioAppear();
    }
    ...
    */
     ...
     */
    function qodefInitSvgSeparator(){

        if($('.qodef-svg-separator').length && $('.qodef-no-animations-on-touch').length === 0){
            $('.qodef-svg-separator').each(function(){
                var separator = $(this);
                separator.appear(function() {
                    separator.addClass('qodef-svg-separator-on');
                    qodef.modules.common.qodefCheckSVG(separator);
                },{accX: 0, accY: qodefGlobalVars.vars.qodefElementAppearAmount});
            });
        }
    ...
    function qodefInitTestimonials(){
        ...
        if(testimonial.length){
            testimonial.each(function(){
                ...
                if (thisTestimonial.hasClass('light')) {
                    thisTestimonial.parent().find('.owl-buttons').addClass('light');
                }

                if (thisTestimonial.hasClass('dark')) {
                    thisTestimonial.parent().find('.owl-buttons').addClass('dark');
                }
                ...
                if(type === 'standard') {
                    ...
                    previous.click(function() {
                        thisTestimonial.trigger('prev.owl.carousel');
                    });

                    next.click(function() {
                        thisTestimonial.trigger('next.owl.carousel');
                    });
    ...
    var qodefButton = qodef.modules.shortcodes.qodefButton = function() {
        ...
        var buttonHoverBgColor = function(button) {
            if(typeof button.data('hover-bg-color') !== 'undefined') {
                ...
                if (!button.is('[class*="qodef-btn-hover"]')) {
        ...
        var buttonHoverAnimationParams = function(button) {
            if (button.find('.qodef-hover-background').length) {
                if((button.css('borderTopRightRadius') !== '')) { //borderTopRightRadius due to Mozilla not getting it
                    ...
                    if (button.hasClass('qodef-btn-hover-sweep')) {
	...
	*/
    ...
    function qodefCustomFontTypeOut() {
        ...
        if (qodefTyped.length) {
            qodefTyped.each(function(){
                ...
                //vars
                var thisTyped = $(this),
                    typedWrap = thisTyped.parent('.qodef-typed-wrap'),
     ...
     * Initializes portfolio list
     */
    function qodefInitPortfolioParallaxRows(){
        var parallaxRows = $('.qodef-portfolio-list-holder-outer.qodef-ptf-parallax-rows');
        if (parallaxRows.length) {
            parallaxRows.each(function(){
                var parallaxRow = $(this),
                    articles = parallaxRow.find('article');
                articles.each(function(){
                    var article = $(this),
                        excerpt = article.find('.qodef-portfolio-excerpt'),
                        excerptHeight = parseInt(excerpt.outerHeight(false)),
                        excerptMarginBottom = parseInt(excerpt.css('margin-bottom')),
                        excerptTotal = excerptHeight + excerptMarginBottom,
                        category = article.find('.qodef-ptf-category-holder'),
                        title = article.find('.qodef-item-title');

                    category.css({'transform':'translateY('+excerptTotal+'px)'});
                    title.css({'transform':'translateY('+excerptTotal+'px)'});
    ...
    */
        ...
        if(portSlider.length){
            portSlider.each(function(){
                ...
                sliderWrapper.owlCarousel({
                    ...
                    nav: navigation,
                    navText: [
                        '<span class="qodef-prev-icon"><i class="arrow ion-arrow-left-c"></i></span>',
                        '<span class="qodef-next-icon"><i class="arrow ion-arrow-right-c"></i></span>'
                    ]
                });
            });
        }
     ...
     */
    function qodefInitPortfolioAppear() {

        var portfolioList = $('.qodef-portfolio-list-holder-outer.qodef-animate-appear');
        if(portfolioList.length){
            portfolioList.each(function(){
                ...
                if(portfolioList.hasClass('qodef-ptf-gallery') || portfolioList.hasClass('qodef-ptf-gallery-space') || portfolioList.hasClass('qodef-ptf-standard')) {
        ...
        if(portList.length){
            portList.each(function(){
                ...
                loadMoreButton.on('click', function (e) {
                    var loadMoreData = qodefGetPortfolioAjaxData(thisPortList);
                    nextPage = loadMoreData.nextPage;
                    e.preventDefault();
                    e.stopPropagation();
                    if(nextPage <= maxNumPages){
                        var ajaxData = qodefSetPortfolioAjaxData(loadMoreData);
                        $.ajax({
                            type: 'POST',
                            data: ajaxData,
                            url: qodeCoreAjaxUrl,
                                ...
                                thisPortList.waitForImages(function(){
                                    setTimeout(function() {
                                        if(thisPortList.hasClass('qodef-ptf-masonry') || thisPortList.hasClass('qodef-ptf-pinterest') ){
                                            ...
                                            qodefInitPortfolioAppear();
                                        } else if(thisPortList.hasClass('qodef-ptf-parallax-rows') || thisPortList.hasClass('qodef-ptf-parallax-expanded') ) {
    ...
    var qodefSlider = qodef.modules.shortcodes.qodefSlider = function() {
        ...
        var setSliderHeight = function(slider, defaultHeight, responsive_breakpoint_set, reset) {
            ...
            slider.find('.qodef-vertical-split-slider-preloader').css({'height': (sliderHeight) + 'px'});
            slider.find('.qodef-vertical-split-slider-preloader .ajax-loader').css({'display': 'block'});
        ...
        var setSliderFullHeight = function(slider) {
            ...
            slider.find('.qodef-vertical-split-slider-preloader').css({'height': (qodef.windowHeight - mobileHeaderHeight) + 'px'});
            slider.find('.qodef-vertical-split-slider-preloader .ajax-loader').css({'display': 'block'});
    ...
    /**
     **  Init fixed portfolio info
     */

    function qodefInitFixedPortfolio() {

        var stickyHeader = $('.qodef-sticky-header'),
            mobileHeader = $('.qodef-mobile-header'),
            fixedHeaderWrapper = $('.qodef-fixed-wrapper').height(),
            fixedContent = $('.qodef-portfolio-fixed-content');

        if (fixedContent.length && qodef.windowWidth > 1024 ) {

            fixedContent.each(function(){

                var thisFixedContent = $(this),
                    parent =  '.qodef-portfolio-single-holder.fixed-left .qodef-two-columns-50-50',
                    stickyHeight = 0;


                if(qodef.body.hasClass('qodef-sticky-header-on-scroll-down-up')){
                    stickyHeight = qodefGlobalVars.vars.qodefStickyHeaderHeight;
                }else if(qodef.body.hasClass('qodef-fixed-on-scroll')){
                    stickyHeight = fixedHeaderWrapper;
                }else{
                    stickyHeight = 0;
                }

                var offset = stickyHeight + 20; //20 is to push down from browser top edge


                thisFixedContent.stick_in_parent({
                    parent: parent,
                    sticky_class : 'qodef-portfolio-stick',
                    inner_scrolling : false,
                    offset_top: offset,
                }).on("sticky_kit:bottom", function() { //check if sticky sidebar have hit the bottom and use that class for pull it down when sticky header appears
                    thisFixedContent.addClass('qodef-fixed-content-on-bottom');
                }).on("sticky_kit:unbottom", function() {
                    thisFixedContent.removeClass('qodef-fixed-content-on-bottom');
                });

                $(window).scroll(function(){
                    if (qodef.windowWidth >= 1024 ) {
                        if (stickyHeader.hasClass('header-appear') && qodef.body.hasClass('qodef-sticky-header-on-scroll-up') && thisFixedContent.hasClass('qodef-portfolio-stick') && !thisFixedContent.hasClass('qodef-fixed-content-on-bottom')) {
                            thisFixedContent.css('-webkit-transform', 'translateY('+qodefGlobalVars.vars.qodefStickyHeaderHeight+'px)');
                            thisFixedContent.css('transform', 'translateY('+qodefGlobalVars.vars.qodefStickyHeaderHeight+'px)');
                        } else {
                            thisFixedContent.css('-webkit-transform', 'translateY(0px)');
                            thisFixedContent.css('transform', 'translateY(0px)');
                        }
                    }else {
                        if ( mobileHeader.hasClass('mobile-header-appear') && thisFixedContent.hasClass('qodef-portfolio-stick') && !thisFixedContent.hasClass('qodef-sticky-sidebar-on-bottom')) {
                            thisFixedContent.css('-webkit-transform', 'translateY('+qodefGlobalVars.vars.qodefMobileHeaderHeight+'px)');
                            thisFixedContent.css('transform', 'translateY('+qodefGlobalVars.vars.qodefMobileHeaderHeight+'px)');
                        } else {
                            thisFixedContent.css('-webkit-transform', 'translateY(0px)');
                            thisFixedContent.css('transform', 'translateY(0px)');
                        }
        ...
        if(elementsHolder.length){
            elementsHolder.each(function() {
                ...
                if(responsiveStyle.length) {
                    style = '<style type="text/css" data-type="aton_qodef_shortcodes_custom_css">'+responsiveStyle+'</style>';
                }
