...
/*
   Interface: iAtonQodefLayoutNode
...
/*
   Class: AtonQodefPanel
   A class that initializes Qode Panel
*/
class AtonQodefPanel implements iAtonQodefLayoutNode, iAtonQodefRender {
	...
	public function render($factory) {
		...
		if (!empty($this->hidden_property)){
			if (aton_qodef_option_get_value($this->hidden_property)==$this->hidden_value)
				$hidden = true;
			else {
				foreach ($this->hidden_values as $value) {
					if (aton_qodef_option_get_value($this->hidden_property)==$value)
						$hidden = true;
	...
	public function renderChild(iAtonQodefRender $child, $factory) {
		$child->render($factory);
	}
}

/*
   Class: AtonQodefContainer
   A class that initializes Qode Container
*/
class AtonQodefContainer implements iAtonQodefLayoutNode, iAtonQodefRender {
...
/*
   Class: AtonQodefContainerNoStyle
   A class that initializes Qode Container without css classes
*/
class AtonQodefContainerNoStyle implements iAtonQodefLayoutNode, iAtonQodefRender {
...
/*
   Class: AtonQodefGroup
   A class that initializes Qode Group
*/
class AtonQodefGroup implements iAtonQodefLayoutNode, iAtonQodefRender {
...
/*
   Class: AtonQodefNotice
   A class that initializes Qode Notice
*/
class AtonQodefNotice implements iAtonQodefRender {
...
*/
class AtonQodefRow implements iAtonQodefLayoutNode, iAtonQodefRender {
...
/*
   Class: AtonQodefTitle
   A class that initializes Qode Title
*/
class AtonQodefTitle implements iAtonQodefRender {
	private $name;
	private $title;
	public $hidden_property;
...
/*
   Class: AtonQodefField
   A class that initializes Qode Field
*/
class AtonQodefField implements iAtonQodefRender {
	private $type;
	private $name;
	...
	function __construct($type,$name,$default_value="",$label="",$description="", $options = array(), $args = array(),$hidden_property="", $hidden_values = array()) {		
		...
		$this->hidden_property = $hidden_property;
		$this->hidden_values = $hidden_values;
		$aton_qodef_Framework->qodeOptions->addOption($this->name,$this->default_value, $type);
	}
...
/*
   Class: AtonQodefMetaField
   A class that initializes Qode Meta Field
*/
class AtonQodefMetaField implements iAtonQodefRender {
	private $type;
	private $name;
	private $default_value;
	private $label;
	...
	function __construct($type,$name,$default_value="",$label="",$description="", $options = array(), $args = array(),$hidden_property="", $hidden_values = array()) {
		...
		$this->hidden_property = $hidden_property;
		$this->hidden_values = $hidden_values;
		$aton_qodef_Framework->qodeMetaBoxes->addOption($this->name,$this->default_value);
	}
...
class AtonQodefFieldText extends AtonQodefFieldType {
	...
	public function render( $name, $label="", $description="", $options = array(), $args = array(), $hidden = false, $repeat = array() ) {
		...
		if (!empty($repeat)) {
			...
			$id = $name;
			$value = aton_qodef_option_get_value($name);
		}
...
class AtonQodefFieldTextSimple extends AtonQodefFieldType {
...
class AtonQodefFieldTextArea extends AtonQodefFieldType {
...
class AtonQodefFieldTextAreaHtml extends AtonQodefFieldType {
...
class AtonQodefFieldTextAreaSimple extends AtonQodefFieldType {
...
class AtonQodefFieldColor extends AtonQodefFieldType {
...
class AtonQodefFieldColorSimple extends AtonQodefFieldType {
...
class AtonQodefFieldImage extends AtonQodefFieldType {
	...
	public function render( $name, $label="", $description="", $options = array(), $args = array(), $hidden = false, $repeat = array() ) {
		...
		if (!empty($repeat)) {
			...
			$value = aton_qodef_option_get_value($name);
			$has_value = aton_qodef_option_has_value($name);
		}
						...
						<div class="col-lg-12 <?php echo esc_attr($class); ?>">
							<div class="qodef-media-uploader">
								<div<?php if (!$has_value) { ?> style="display: none"<?php } ?>
									...
									<img src="<?php if ($has_value) { echo esc_url(aton_qodef_get_attachment_thumb_url($value)); } ?>" alt=""
...
class AtonQodefFieldImageSimple extends AtonQodefFieldType {
...
class AtonQodefFieldFont extends AtonQodefFieldType {
...
class AtonQodefFieldFontSimple extends AtonQodefFieldType {
...
class AtonQodefFieldSelect extends AtonQodefFieldType {
	...
	public function render( $name, $label="", $description="", $options = array(), $args = array(), $hidden = false, $repeat = array() ) {
		...
		if (!empty($repeat)) {
			...
			$id = $name;
			$rvalue = aton_qodef_option_get_value($name);
		}
...
class AtonQodefFieldSelectBlank extends AtonQodefFieldType {
...
class AtonQodefFieldSelectSimple extends AtonQodefFieldType {
...
class AtonQodefFieldSelectBlankSimple extends AtonQodefFieldType {
...
class AtonQodefFieldYesNo extends AtonQodefFieldType {
						...
						<div class="col-lg-12 <?php echo esc_attr($class); ?>">
							<p class="field switch">
								<label data-hide="<?php echo esc_attr($dependence_hide_on_yes); ?>" data-show="<?php echo esc_attr($dependence_show_on_yes); ?>"
									   class="cb-enable<?php if ($rvalue == "yes") { echo " selected"; } ?><?php if ($dependence) { echo " dependence"; } ?>"><span><?php esc_html_e('Yes', 'aton') ?></span></label>
								<label data-hide="<?php echo esc_attr($dependence_show_on_yes); ?>" data-show="<?php echo esc_attr($dependence_hide_on_yes); ?>"
									   class="cb-disable<?php if ($rvalue == "no") { echo " selected"; } ?><?php if ($dependence) { echo " dependence"; } ?>"><span><?php esc_html_e('No', 'aton') ?></span></label>
...
class AtonQodefFieldYesNoSimple extends AtonQodefFieldType {
