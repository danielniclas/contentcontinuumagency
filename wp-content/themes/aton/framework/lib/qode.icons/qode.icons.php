...
/*
  Class: AtonQodefIconCollections
...
class AtonQodefIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new AtonQodefIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new AtonQodefIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new AtonQodefIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new AtonQodefLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new AtonQodefSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new AtonQodefDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getIconCollectionIcons(iAtonQodefIconCollection $collection) {
...
if ( ! function_exists( 'aton_qodef_activate_theme_icons' ) ) {

    function aton_qodef_activate_theme_icons() {
        global $aton_qodef_IconCollections;
        $aton_qodef_IconCollections = AtonQodefIconCollections::get_instance();
    }

    add_action('after_setup_theme', 'aton_qodef_activate_theme_icons');
}