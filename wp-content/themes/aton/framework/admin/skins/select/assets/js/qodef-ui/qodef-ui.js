(function($){
            ...
            frame: function() {
                ...
                this._frame.on('update', function() {
                    ...
                    jQuery.ajax({
                        type: "post",
                        url: ajaxurl,
                        data: "action=aton_qodef_gallery_upload_get_images&ids=" + ids,
    ...
    function qodefInitPortfolioItemsBox() {
        ...
        $('.qodef-portfolio-add a.qodef-add-item').click(function (event) {
            event.preventDefault();
    ...
    */
    ...
    function qodefInitSlideElementItemsBox() {
        ...
        $('.qodef-slide-element-add a.qodef-add-item').click(function (event) {
            var qodef_slide_element = $('.qodef-slide-element-additional-item-holder').clone().html();
            $slide_element = '<div class="qodef-slide-element-additional-item" rel="">'+ qodef_slide_element +'</div>';
            event.preventDefault();
    ...
    */
    ...
    function qodefInitAjaxForm() {
        ...
        var b = $(this);
        var c = {
            action: "aton_qodef_save_options"
        };
        jQuery.ajax({
            url: ajaxurl,
            cache: !1,
