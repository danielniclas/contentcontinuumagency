...
if ( ! function_exists('aton_qodef_contact_form_7_options_map') ) {

	function aton_qodef_contact_form_7_options_map() {

		aton_qodef_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'aton'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = aton_qodef_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'aton')
		));

		//Text Typography

		$typography_text_group = aton_qodef_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'aton'),
			'description'	=> esc_html__('Setup typography for form elements text', 'aton'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = aton_qodef_add_admin_row(array(
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'aton'),
		));
		...
		$typography_text_row2 = aton_qodef_add_admin_row(array(
		...
		$typography_text_row3 = aton_qodef_add_admin_row(array(
		...
		$typography_label_group = aton_qodef_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'aton'),
			'description'	=> esc_html__('Setup typography for form elements label', 'aton'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = aton_qodef_add_admin_row(array(
		...
		$typography_label_row2 = aton_qodef_add_admin_row(array(
		...
		$background_border_group = aton_qodef_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'aton'),
			'description'	=> esc_html__('Setup form elements background and border style', 'aton'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = aton_qodef_add_admin_row(array(
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'aton')
		));
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'aton')
		));

		$background_border_row2 = aton_qodef_add_admin_row(array(
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'aton'),
		));
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'aton')
		));
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'aton')
		));

		$background_border_row3 = aton_qodef_add_admin_row(array(
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'aton'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'aton'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = aton_qodef_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'aton'),
			'description'	=> esc_html__('Setup form elements padding', 'aton'),
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = aton_qodef_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'aton'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'aton'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = aton_qodef_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'aton'),
			'description'	=> esc_html__('Setup form elements margin', 'aton'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = aton_qodef_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Margin Top', 'aton'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Margin Bottom', 'aton'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'aton'),
			'description'	=> esc_html__('Enter height for textarea form element', 'aton'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = aton_qodef_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'aton'),
			'description'	=> esc_html__('Setup button text typography', 'aton'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = aton_qodef_add_admin_row(array(
		...
		$button_typography_row2 = aton_qodef_add_admin_row(array(
		...
		$button_background_border_group = aton_qodef_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'aton'),
			'description'	=> esc_html__('Setup button background and border style', 'aton'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = aton_qodef_add_admin_row(array(
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'aton')
		));

		$button_background_border_row2 = aton_qodef_add_admin_row(array(
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'aton')
		));
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'aton')
		));

		$button_background_border_row3 = aton_qodef_add_admin_row(array(
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'aton'),
			'description'	=> esc_html__('Insert form button height', 'aton'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		aton_qodef_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'aton'),
			'description'	=> esc_html__('Enter value for button left and right padding', 'aton'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = aton_qodef_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'aton')
		));
	...
	add_action( 'aton_qodef_options_map', 'aton_qodef_contact_form_7_options_map',10);
