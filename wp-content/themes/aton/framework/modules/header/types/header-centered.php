...
class HeaderCentered extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $logoAreaHeight       = aton_qodef_filter_px(aton_qodef_options()->getOptionValue('logo_area_height_header_centered'));
            $this->logoAreaHeight = $logoAreaHeight !== '' ? (int)$logoAreaHeight : (int)80;

            $menuAreaHeight       = aton_qodef_filter_px(aton_qodef_options()->getOptionValue('menu_area_height_header_centered'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['menu_area_in_grid'] = aton_qodef_get_meta_field_intersect('menu_area_in_grid_header_centered') == 'yes' ? true : false;

        $parameters = apply_filters('aton_qodef_header_centered_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } elseif(aton_qodef_options()->getOptionValue('menu_area_background_color_header_centered') == '') {
            $menuAreaTransparent = aton_qodef_options()->getOptionValue('menu_area_grid_background_color_header_centered') !== '' &&
                aton_qodef_options()->getOptionValue('menu_area_grid_background_transparency_header_centered') !== '1';
        } else {
            $menuAreaTransparent = aton_qodef_options()->getOptionValue('menu_area_background_color_header_centered') !== '' &&
                aton_qodef_options()->getOptionValue('menu_area_background_transparency_header_centered') !== '1';
        }
        ...
        if($menuAreaTransparent) {
            ...
            if(($sliderExists && aton_qodef_is_top_bar_enabled())
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        if(get_post_meta($id, 'qodef_menu_area_background_color_header_centered_meta', true) !== ''){
            ...
            $menuAreaTransparent = aton_qodef_options()->getOptionValue('menu_area_grid_background_color_header_centered') !== '' &&
                aton_qodef_options()->getOptionValue('menu_area_grid_background_transparency_header_centered') === '0';
        } else {
            $menuAreaTransparent = aton_qodef_options()->getOptionValue('menu_area_background_color_header_centered') !== '' &&
                aton_qodef_options()->getOptionValue('menu_area_background_transparency_header_centered') === '0';
        }
