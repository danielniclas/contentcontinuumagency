...
if(!function_exists('aton_qodef_single_portfolio')) {
    function aton_qodef_single_portfolio() {
        $portfolio_template = aton_qodef_get_portfolio_single_type();

        $params = array(
            'portfolio_template' => $portfolio_template,
            'fullwidth'          => $portfolio_template == 'full-width-custom' || $portfolio_template == 'full-width-images' || $portfolio_template == 'full-width-custom-info-bottom' || $portfolio_template == 'fixed-left',
            'holder_class'       => array(
                $portfolio_template,
        ...
        if ($portfolio_template == 'gallery') {
            $params['holder_class'][] = 'qodef-portfolio-gallery-' . aton_qodef_options()->getOptionValue('portfolio_single_numb_columns');
        }

        aton_qodef_get_module_template_part('templates/single/holder', 'portfolio', '', $params);
    }
}

if(!function_exists('aton_qodef_get_portfolio_single_type')) {
    function aton_qodef_get_portfolio_single_type() {
        return aton_qodef_get_meta_field_intersect('portfolio_single_template');
    }
}

if(!function_exists('aton_qodef_get_portfolio_single_media')) {
    function aton_qodef_get_portfolio_single_media() {
        ...
        if($image_ids !== '') {
            ...
            foreach($image_ids as $image_id) {
                ...
                $media['predefined_size'] = get_post_meta($image_id,'qodef_portfolio_single_predefined_size',true);
        ...
        if(is_array($videos) && count($videos)) {
            usort($videos, 'aton_qodef_compare_portfolio_videos');
            foreach($videos as $video) {
                ...
                if(!empty($video['portfoliovideotype'])) {
                    ...
                    $media['video_url']   = aton_qodef_portfolio_get_video_url($video);
                    $media['predefined_size'] = get_post_meta($video,'qodef_portfolio_single_predefined_size',true);
...
if(!function_exists('aton_qodef_portfolio_get_video_url')) {
    function aton_qodef_portfolio_get_video_url($video) {
...
if(!function_exists('aton_qodef_portfolio_get_media_html')) {
    function aton_qodef_portfolio_get_media_html($media) {
        global $wp_filesystem;
        $params = array();

        //For adding image overlay in gallery template types

        $params['gallery'] = false;
        if(aton_qodef_get_portfolio_single_type() == 'gallery' || aton_qodef_get_portfolio_single_type() == 'pinterest' || aton_qodef_get_portfolio_single_type() == 'pinterest-left' || aton_qodef_get_portfolio_single_type() == 'pinterest-right' || aton_qodef_get_portfolio_single_type() == 'masonry-gallery-bottom' || aton_qodef_get_portfolio_single_type() == 'masonry-gallery-left'){
            $params['gallery'] = true;
        }


        if($media['type'] == 'image') {
            $params['lightbox'] = aton_qodef_options()->getOptionValue('portfolio_single_lightbox_images') == 'yes';
        ...
        if(in_array($media['type'], array('youtube', 'vimeo'))) {
            $params['lightbox'] = aton_qodef_options()->getOptionValue('portfolio_single_lightbox_videos') == 'yes';
        ...
        aton_qodef_get_module_template_part('templates/single/media/'.$media['type'], 'portfolio', '', $params);
    }
}

if(!function_exists('aton_qodef_compare_portfolio_videos')) {
    /**
     ...
     */
    function aton_qodef_compare_portfolio_videos($a, $b) {
...
if(!function_exists('aton_qodef_compare_portfolio_options')) {
    /**
     ...
     * @return int result of comparison
     */
    function aton_qodef_compare_portfolio_options($a, $b) {
...
if(!function_exists('aton_qodef_portfolio_get_info_part')) {
    function aton_qodef_portfolio_get_info_part($part) {
        $portfolio_template = aton_qodef_get_portfolio_single_type();

        aton_qodef_get_module_template_part('templates/single/parts/'.$part, 'portfolio', $portfolio_template);
    }
}