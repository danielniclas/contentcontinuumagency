...
if(aton_qodef_options()->getOptionValue('pagination') == 'yes') {
    ...
    if(aton_qodef_options()->getOptionValue('gallery_pagination_type') != '' ) {
        $pagination_type = aton_qodef_options()->getOptionValue('gallery_pagination_type');
    }
    ...
    if ($pagination_type == 'navigation') {
        ...
        aton_qodef_pagination($blog_query->max_num_pages, $blog_page_range, $paged, 'gallery');
    }
}
?>
