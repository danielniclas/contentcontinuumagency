<?php
namespace AtonQodef\Modules\Shortcodes\CallToAction;
...
class CallToAction implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		$call_to_action_button_IconCollections = aton_qodef_icon_collections()->iconCollections;
		foreach($call_to_action_button_IconCollections as $collection_key => $collection) {

			$call_to_action_button_icons_array[] = array(
				'type' => 'dropdown',
				'heading' => esc_html__('Button Icon', 'aton'),
		...
		vc_map( array(
				'name' => esc_html__('Select Call To Action', 'aton'),
				'base' => $this->getBase(),
				'category' => 'by SELECT',
				...
				'params' => array_merge(
					array(
						array(
							'type'          => 'dropdown',
							'heading'       => esc_html__('Full Width', 'aton'),
						...
						array(
							'type'          => 'dropdown',
							'heading'       => esc_html__('Content in grid', 'aton'),
						...
						array(
							'type'          => 'dropdown',
							'heading'       => esc_html__('Grid size', 'aton'),
							'param_name'    => 'grid_size',
							'value'         => array(
								esc_html__('75/25', 'aton')     => '75',
								esc_html__('50/50', 'aton')     => '50',
								esc_html__('66/33', 'aton')     => '66'
							),
							'save_always' 	=> true,
							'description'   => '',
						...
						array(
							...
							'value' 		=> array(
								...
								esc_html__('With Icon', 'aton') => 'with-icon',
							),
							'save_always' 	=> true,
							'description' 	=> ''
						)
					),
					aton_qodef_icon_collections()->getVCParamsArray(array('element' => 'type', 'value' => array('with-icon'))),
					array(
						array(
							'type' 			=> 'textfield',
						...
						array(
							'type' 			=> 'textfield',
							'heading' 		=> esc_html__('Box Padding (top right bottom left) px', 'aton'),
							'param_name' 	=> 'box_padding',
							'admin_label' 	=> true,
							'description' 	=> esc_html__('For example, 20px 5px 10px 15px', 'aton'),
							'group'			=> esc_html__('Design Options', 'aton')
						),
						array(
							'type' 			=> 'textfield',
							'heading' 		=> esc_html__('Default Text Font Size (px)', 'aton'),
							'param_name' 	=> 'text_size',
							'description' 	=> esc_html__('Font size for p tag', 'aton'),
							'group'			=> esc_html__('Design Options', 'aton'),
						),
						array(
							'type' 			=> 'dropdown',
						...
						array(
							'type' => 'dropdown',
							'heading' => esc_html__('Button Position', 'aton'),
							'param_name' => 'button_position',
							'value' => array(
								esc_html__('Default/right', 'aton') => '',
						...
						array(
							...
							'admin_label' 	=> true,
							'description' => esc_html__('Default text is "button"', 'aton'),
							'dependency' => array('element' => 'show_button', 'value' => array('yes'))
						),
						array(
							'type' => 'textfield',
						...
						array(
							'type' => 'dropdown',
							'heading' => esc_html__('Button Target', 'aton'),
						...
						array(
							'type' => 'dropdown',
							'heading' => esc_html__('Button Size', 'aton'),
							...
							'value' => array(
								...
								esc_html__('Extra Large', 'aton') => 'big_large'
							),
							'description' => '',
							'dependency' => array('element' => 'show_button', 'value' => array('yes')),
						...
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__('Button Text Color', 'aton'),
						...
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__('Button Background Color', 'aton'),
						...
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__('Button Border Color', 'aton'),
						...
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__('Button Hover Text Color', 'aton'),
						...
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__('Button Hover Background Color', 'aton'),
						...
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__('Button Hover Border Color', 'aton'),
						...
						array(
							'type' => 'dropdown',
							'heading' => esc_html__('Button Icon Pack', 'aton'),
							'param_name' => 'button_icon_pack',
							'value' => array_merge(array('No Icon' => ''),aton_qodef_icon_collections()->getIconCollectionsVC()),
							'save_always' => true,
							'dependency' => array('element' => 'show_button', 'value' => array('yes'))
						)
					),
	...
	public function render($atts, $content = null) {
		...
		$args = array_merge($args, aton_qodef_icon_collections()->getShortcodeParams(),$call_to_action_icons_form_fields);
		...
		$html = aton_qodef_get_shortcode_module_template_part('templates/call-to-action-template', 'calltoaction', '', $params);
	...
	private function getCallToActionIcon($params) {
		...
		if(!empty($params[$icon])){			
			$call_to_action_icon = aton_qodef_icon_collections()->renderIcon( $params[$icon], $params['icon_pack'], $iconStyles );
		}
	...
	private function getButtonParameters($params) {
		...
		if(!empty($params['button_icon_pack'])) {
			...
			$iconPackName = aton_qodef_icon_collections()->getIconCollectionParamNameByKey($params['button_icon_pack']);
