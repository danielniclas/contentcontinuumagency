<?php
namespace AtonQodef\Modules\Shortcodes\VideoButton;
...
class VideoButton implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Select Video Button', 'aton'),
				'base' => $this->getBase(),
				'category' => 'by SELECT',
				...
				'params' => array(
					...
					array(
						"type" => "textfield",
						"heading" => esc_html__('Video Link', 'aton'),
						"param_name" => "video_link",
						"value" => ""
					),
					array(
						"type" => "textfield",
						"heading" => esc_html__('Play Button Size (px)', 'aton'),
	...
	public function render($atts, $content = null) {
		...
		$html = aton_qodef_get_shortcode_module_template_part('templates/video-button-template', 'videobutton', '', $params);
