<?php
namespace AtonQodef\Modules\Shortcodes\CustomFont;
...
class CustomFont implements ShortcodeInterface {
	...
	public function vcMap() {
		...
		vc_map( array(
				'name' => esc_html__('Select Custom Font', 'aton'),
				'base' => $this->getBase(),
				'category' => 'by SELECT',
				...
				'params' => array(
					array(
						"type" => "textfield",
						"heading" => esc_html__('Font family', 'aton'),
					...
					array(
						"type" => "textfield",
						"heading" => esc_html__('Line height (px)', 'aton'),
						"param_name" => "line_height",
						"value" => ""
					),
					array(
						"type" => "dropdown",
						"heading" => esc_html__('Font Style', 'aton'),
						"param_name" => "font_style",
						"value" => aton_qodef_get_font_style_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
					...
					array(
						"type" => "textfield",
						"heading" => esc_html__('Letter Spacing (px)', 'aton'),
					...
					array(
						...
						"value" => aton_qodef_get_text_transform_array(),
						"description" => ""
					),
					array(
						"type" => "dropdown",
						"heading" => esc_html__('Text decoration', 'aton'),
						"param_name" => "text_decoration",
						"value" => array(
							esc_html__("None", 'aton') => "",
							esc_html__("Underline", 'aton') => "underline",
							esc_html__("Overline", 'aton') => "overline",
							esc_html__("Line Through", 'aton') => "line-through"
						),
						"description" => ""
					),
					array(
					...
					array(
						"type" => "dropdown",
						"heading" => esc_html__('Text Align', 'aton'),
						...
						"value" => array(
							...
							esc_html__("Justify", 'aton') => "justify"
						),
						"description" => ""
					),
					array(
						...
						"heading" => "Content",
						"param_name" => "content",
						"value" => esc_html__('Custom Font Content', 'aton'),
						"description" => "",
						"save_always" => true
					),
                    array(
                        "type" => "dropdown",
                        "heading" => esc_html__('Enable Type Out Effect', 'aton'),
                        "param_name" => "type_out_effect",
                        "value" => array(
                            esc_html__("No", 'aton') => "no",
                            esc_html__("Yes", 'aton') => "yes",
                        ),
                        "description" => esc_html__('Adds a type out effect at the end of the custom font content.', 'aton')
                    ),
                    array(
                        "type" => "textarea",
                        "heading" => esc_html__('Typed ending number 1', 'aton'),
                    ...
                    array(
                        "type" => "textarea",
                        "heading" => esc_html__('Typed ending number 2', 'aton'),
                    ...
                    array(
                        "type" => "textarea",
                        "heading" => esc_html__('Typed ending number 3', 'aton'),
	...
	public function render($atts, $content = null) {
		...
		$html = aton_qodef_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);
    ...
    /**
     * Return Custom Font Type Out Data Attr
     *
     * @param $params
     * @return string
     */
