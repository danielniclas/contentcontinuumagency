<div <?php aton_qodef_class_attribute($holder_classes); ?>  <?php aton_qodef_inline_style($holder_parameters); ?>>
    ...
    <div class="qodef-iwt-content-holder" <?php aton_qodef_inline_style($content_styles); ?>>
        <?php if($title != '') { ?>
