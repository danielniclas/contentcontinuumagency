...
if ( ! function_exists('aton_qodef_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function aton_qodef_configure_visual_composer() {
	...
	add_action('vc_after_init', 'aton_qodef_configure_visual_composer');

}


if ( ! function_exists('aton_qodef_configure_visual_composer_grid_elemets') ) {
	...
	function aton_qodef_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'aton_qodef_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('aton_qodef_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function aton_qodef_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'aton_qodef_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Qodef_Timeline extends WPBakeryShortCodesContainer {}
	...
	class WPBakeryShortCode_Qodef_Vertical_Split_Slider_Item extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Qodef_Advanced_Vertical_Slider extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Qodef_Advanced_Vertical_Slider_Item extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Qodef_Parallax_Sections extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Qodef_Parallax_Section extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Qodef_Process_Holder extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Qodef_Process_Item extends WPBakeryShortCodesContainer {}
}
...
/*** Row ***/
if ( ! function_exists('aton_qodef_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function aton_qodef_vc_row_map()
	{
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Row Type', 'aton'),
			'param_name' => 'row_type',
			'value' => array(
				esc_html__('Row', 'aton') => 'row',
				esc_html__('Parallax', 'aton') => 'parallax'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Content Width', 'aton'),
			'param_name' => 'content_width',
			'value' => array(
				esc_html__('Full Width', 'aton') => 'full-width',
				esc_html__('In Grid', 'aton') => 'grid'
			)
		));
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Header Style', 'aton'),
			'param_name' => 'header_style',
			'value' => array(
				esc_html__('Default', 'aton') => '',
				esc_html__('Light', 'aton') => 'qodef-light-header',
				esc_html__('Dark', 'aton') => 'qodef-dark-header'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Anchor ID', 'aton'),
			'param_name' => 'anchor',
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Content Aligment', 'aton'),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Video Background', 'aton'),
			'value' => array(
				esc_html__('No', 'aton') => '',
				esc_html__('Yes', 'aton') => 'show_video'
			),
			'param_name' => 'video',
			'description' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Video Overlay', 'aton'),
			'value' => array(
				esc_html__('No', 'aton') => '',
				esc_html__('Yes', 'aton') => 'show_video_overlay'
			),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Video Overlay Image (pattern)', 'aton'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (webm) File URL', 'aton'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (mp4) file URL', 'aton'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Video Background (ogv) file URL', 'aton'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Video Preview Image', 'aton'),
			'value' => '',
		...
		vc_add_param("vc_row", array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Full Screen Height', 'aton'),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'class' => '',
			'heading' => esc_html__('Vertically Align Content In Middle', 'aton'),
        ...
        vc_add_param('vc_row', array(
            'type' => 'dropdown',
            'heading' => esc_html__('Arrow Down ', 'aton'),
        ...
        vc_add_param('vc_row', array(
            'type' => 'textfield',
            'class' => '',
            'heading' => esc_html__('Arrow Down Anchor', 'aton'),
            'param_name' => 'arrow_down_anchor',
            'value' => '',
            'dependency' => Array('element' => 'arrow_down', 'value' => array('yes'))
        ));

        vc_add_param('vc_row', array(
            'type' => 'colorpicker',
            'heading' => esc_html__('Arrow Down Color', 'aton'),
            'param_name' => 'arrow_down_color',
            'value' => '',
            'description' => '',
            'dependency' => Array('element' => 'arrow_down',  'value' => array('yes'))
        ));
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Section Height', 'aton'),
		...
		vc_add_param('vc_row', array(
			'type' => 'attach_image',
			'class' => '',
			'heading' => esc_html__('Parallax Background image', 'aton'),
			'value' => '',
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'class' => '',
			'heading' => esc_html__('Parallax speed', 'aton'),
		...
		vc_add_param('vc_row', array(
			'type' => 'dropdown',
			'heading' => esc_html__('CSS Animation', 'aton'),
		...
		vc_add_param('vc_row', array(
			'type' => 'textfield',
			'heading' => esc_html__('Transition delay (ms)', 'aton'),
        ...
        vc_add_param('vc_row', array(
            'type' => 'textfield',
            'heading' => esc_html__('Full width scrolling text in background', 'aton'),
        ...
        vc_add_param('vc_row', array(
            'type' => 'colorpicker',
            'heading' => esc_html__('Scrolling Text Color', 'aton'),
            'param_name' => 'scrolling_text_color',
            'group'       => esc_html__('Scrolling Text Style', 'aton'),
            'value' => '',
            'description' => '',
        ...
        vc_add_param('vc_row', array(
            'type' => 'textfield',
            'heading' => esc_html__('Scrolling Text Font Size', 'aton'),
        ...
        vc_add_param('vc_row', array(
            "type" => "textfield",
            "heading" => esc_html__("Scrolling Text Font family", 'aton'),
        ...
        vc_add_param('vc_row', array(
            'type' => 'dropdown',
            'heading' => esc_html__('Scrolling Text Font Weight', 'aton'),
            'param_name' => 'scrolling_text_font_weight',
            'group'       => esc_html__('Scrolling Text Style', 'aton'),
            'value' => aton_qodef_get_font_weight_array(true),
            'dependency' => Array('element' => 'scrolling_text',  'not_empty' => true)

        ));
        vc_add_param('vc_row', array(
            'type' => 'textfield',
            'heading' => esc_html__('Scrolling Text Letter Spacing', 'aton'),
        ...
        vc_add_param('vc_row', array(
            'type' => 'dropdown',
            'heading' => esc_html__('Scrolling Text Text Transform', 'aton'),
        ...
        vc_add_param('vc_row', array(
            'type' => 'dropdown',
            'heading' => esc_html__('Scrolling Text Font Style', 'aton'),
            'param_name' => 'scrolling_text_font_style',
            'group'       => esc_html__('Scrolling Text Style', 'aton'),
            "value" => aton_qodef_get_font_style_array(true),
            'description' => '',
            'dependency' => Array('element' => 'scrolling_text',  'not_empty' => true)
		...
		vc_add_param('vc_row_inner', array(
			...
			'value' => '',
			'param_name' => 'parallax_background_image',
			'description' => esc_html__('Please note that for parallax row type, background image from Design Options will not work so you should to fill this field', 'aton'),
			'dependency' => Array('element' => 'row_type', 'value' => array('parallax'))
		));
	...
	add_action('vc_after_init', 'aton_qodef_vc_row_map');
}
